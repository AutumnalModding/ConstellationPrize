package xyz.lilyflower.epsilon.client.display;
...
import xyz.lilyflower.epsilon.client.display.module.GenericModule;
import xyz.lilyflower.epsilon.init.EPSILON;
...
public class DisplayManager {
    ...
    public static void load() {
        ...
        for (Class<? extends GenericModule> clazz : modules) {
            EPSILON.LOGGER.info("Found diplay module {}", clazz.getSimpleName());
            try {
