package xyz.lilyflower.epsilon.text.command;

import java.util.HashMap;
import xyz.lilyflower.epsilon.text.command.type.ControlCommands;
import xyz.lilyflower.epsilon.text.command.type.EventFlagCommands;
import xyz.lilyflower.epsilon.text.command.type.SpecialCommands;
import xyz.lilyflower.epsilon.text.command.type.StackManipulationCommands;
import xyz.lilyflower.epsilon.text.command.type.StateCommands;
import xyz.lilyflower.epsilon.text.command.type.VisualCommands;
